...
import {foodReducer, snakeReducer, specialFoodReducer} from './Reducer.js'
...
const placingSpecialFood$ = Observable.irregularIntervals(10, 1, 5)
    .pipe(
...
const game$ = Observable.mergeAll(moves$, placingFood$, placingSpecialFood$)
    .pipe(map(() => {
